...
<div align="center">
  :mortar_board: Computer Science Master's Student <br>
  <br>
  <picture>
  ...
  :chart_with_upwards_trend: Optimization<br>
  :penguin: Linux (especially :snowflake: NixOS)<br>
  :open_book: Open Source (see what I use <a href="https://github.com/julius-boettger/software-list" target="_blank" rel="noreferrer">here</a>!)<br>
  :gear: Low-Level Programming (especially in :crab: Rust)
</div>
